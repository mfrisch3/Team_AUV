...
while True:
    ...
    # Plot frequency-domain data (FFT) in separate figures with auto-adjusting y-axis
    plt.figure(2)
    plt.clf()
    ...
    plt.ylabel('Voltage [V]')
    plt.title('FFT of D0')
    plt.ylim(0, max(FFT_D0) * 1.1)  # Auto adjust Y-axis
    ...
    plt.ylabel('Voltage [V]')
    plt.title('FFT of D1')
    plt.ylim(0, max(FFT_D1) * 1.1)  # Auto adjust Y-axis
    ...
    plt.ylabel('Voltage [V]')
    plt.title('FFT of D2')
    plt.ylim(0, max(FFT_D2) * 1.1)  # Auto adjust Y-axis
